...
更新时间：2025/06/23
![该图展示米家生态中设备通过蓝牙网关与云端通信，支持设备数据上报（ADV）和配网/OTA/直连控制（GATT），用户可通过米家App进行统一管理。](static/images/miot-ble-basic/60fac9272fa146a8.png)
...
![该图展示了米家APP通过云端与蓝牙网关连接，进而控制多个智能设备（如温湿度计、门锁及其他设备）的物联网架构，实现远程设备管理与交互。](static/images/miot-ble-basic/c0eba7a8cc069c4c.png)
...
![该图展示了小米开发者平台“平台资源申请”界面，列出了多项技术资源申请项，如蓝牙Spec修改、SDK申请、云存配置等，供开发者按需提交申请。](static/images/miot-ble-basic/45d46b767b619637.png)
<!-- caption: 该图展示了小米开发者平台“平台资源申请”界面，列出了多项技术资源申请项，如蓝牙Spec修改、SDK申请、云存配置等，供开发者按需提交申请。 -->

![该图展示了云端通过网关与在线设备进行双向通信，而离线设备则无法连接网关，表明系统支持设备在线状态管理与数据同步机制。](static/images/miot-ble-basic/a6da46d8a8d28274.png)
...
![该图展示在小米IoT开发者平台中编辑温湿度传感器属性“temperature”的界面，配置其描述、格式、功能用途、权限及数值范围等参数，用于定义设备上报数据的特性。](static/images/miot-ble-basic/287933cf7aeea960.png)
